...
public enum PlayerTextKey {
    ...
    RECOVERY_STARTING_RESOURCES("recovery.startingResources"),
    RECOVERY_DEFEAT_RECOVERED("recovery.defeatRecovered"),
    RECOVERY_BANDAGE_USED("recovery.bandageUsed"),
    RECOVERY_FOOD_STARTED("recovery.foodStarted"),
    RECOVERY_NO_BANDAGES("recovery.noBandages"),
    RECOVERY_NO_FOOD("recovery.noFood"),
    RECOVERY_FOOD_ALREADY_ACTIVE("recovery.foodAlreadyActive"),
    RECOVERY_DEFEAT_COST_BANDAGE("recovery.defeatCostBandage"),
    RECOVERY_DEFEAT_COST_FOOD("recovery.defeatCostFood"),
    RECOVERY_DEFEAT_COST_NONE("recovery.defeatCostNone"),
    RECOVERY_EMERGENCY_CACHE_CLAIMED("recovery.emergencyCacheClaimed"),
    RECOVERY_EMERGENCY_CACHE_EXHAUSTED("recovery.emergencyCacheExhausted"),
